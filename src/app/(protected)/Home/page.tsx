...
const NEX_GOLD_STAKING_ABI: Abi = [
    {"inputs":[{"internalType":"address","name":"","type":"address"}],"name":"stakers","outputs":[{"internalType":"uint256","name":"stakedBalance","type":"uint256"},{"internalType":"uint256","name":"lockinEndDate","type":"uint256"},{"internalType":"uint256","name":"lastStakingRewardUpdateTime","type":"uint256"},{"internalType":"uint256","name":"lastMiningRewardUpdateTime","type":"uint256"}],"stateMutability":"view","type":"function"},
    {"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"calculateStakingRewards","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},
    {"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"calculateMiningRewards","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},
    {"inputs":[],"name":"claimAllRewards","outputs":[],"stateMutability":"nonpayable","type":"function"},
    {"inputs":[{"internalType":"uint256","name":"_amount","type":"uint256"},{"internalType":"uint256","name":"root","type":"uint256"},{"internalType":"uint256","name":"nullifierHash","type":"uint256"},{"internalType":"uint256[8]","name":"proof","type":"uint256[8]"},{"components":[{"components":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"amount","type":"uint256"}],"internalType":"struct ISignatureTransfer.TokenPermissions","name":"permitted","type":"tuple"},{"internalType":"address","name":"spender","type":"address"},{"internalType":"uint256","name":"nonce","type":"uint256"},{"internalType":"uint256","name":"deadline","type":"uint256"}],"internalType":"struct ISignatureTransfer.PermitTransferFrom","name":"permit","type":"tuple"},{"components":[{"internalType":"address","name":"signer","type":"address"},{"internalType":"bytes","name":"signature","type":"bytes"}],"internalType":"struct ISignatureTransfer.Signature","name":"signature","type":"tuple"}],"name":"stake","outputs":[],"stateMutability":"nonpayable","type":"function"},
    ...
    const fetchContractData = useCallback(async () => {
        ...
        try {
            const [staker, stakingRewards, miningRewards] = await Promise.all([
                publicClient.readContract({ address: NEX_GOLD_STAKING_ADDRESS, abi: NEX_GOLD_STAKING_ABI, functionName: 'stakers', args: [session.user.walletAddress] }),
                publicClient.readContract({ address: NEX_GOLD_STAKING_ADDRESS, abi: NEX_GOLD_STAKING_ABI, functionName: 'calculateStakingRewards', args: [session.user.walletAddress] }),
                publicClient.readContract({ address: NEX_GOLD_STAKING_ADDRESS, abi: NEX_GOLD_STAKING_ABI, functionName: 'calculateMiningRewards', args: [session.user.walletAddress] }),
            ]);
            setContractData({
